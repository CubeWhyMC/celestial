...
class ReleaseEntity {
    ...
    override fun equals(o: Any?): Boolean {
        ...
        if (if (`this$body` == null) `other$body` != null else `this$body` != `other$body`) return false
        return true
    }
    ...
    override fun hashCode(): Int {
        ...
        result = result * PRIME + (`$assets_url`?.hashCode() ?: 43)
        val `$upload_url`: Any? = this.upload_url
        result = result * PRIME + (`$upload_url`?.hashCode() ?: 43)
        ...
        result = result * PRIME + (`$tag_name`?.hashCode() ?: 43)
        val `$target_commitish`: Any? = this.target_commitish
        result = result * PRIME + (`$target_commitish`?.hashCode() ?: 43)
        ...
        result = result * PRIME + (`$created_at`?.hashCode() ?: 43)
        val `$published_at`: Any? = this.published_at
        result = result * PRIME + (`$published_at`?.hashCode() ?: 43)
        val `$assets`: Any? = this.assets
        result = result * PRIME + (`$assets`?.hashCode() ?: 43)
        val `$tarball_url`: Any? = this.tarball_url
        result = result * PRIME + (`$tarball_url`?.hashCode() ?: 43)
        val `$zipball_url`: Any? = this.zipball_url
        result = result * PRIME + (`$zipball_url`?.hashCode() ?: 43)
        val `$body`: Any? = this.body
        result = result * PRIME + (`$body`?.hashCode() ?: 43)
        return result
    }
