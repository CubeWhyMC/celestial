...
class Uploader {
    ...
    override fun hashCode(): Int {
        ...
        result = result * PRIME + (`$login`?.hashCode() ?: 43)
        val `$id` = this.id
        result = result * PRIME + (`$id` ushr 32 xor `$id`).toInt()
        val `$node_id`: Any? = this.node_id
        result = result * PRIME + (`$node_id`?.hashCode() ?: 43)
        val `$avatar_url`: Any? = this.avatar_url
        result = result * PRIME + (`$avatar_url`?.hashCode() ?: 43)
        val `$gravatar_id`: Any? = this.gravatar_id
        result = result * PRIME + (`$gravatar_id`?.hashCode() ?: 43)
        val `$url`: Any? = this.url
        result = result * PRIME + (`$url`?.hashCode() ?: 43)
        val `$html_url`: Any? = this.html_url
        result = result * PRIME + (`$html_url`?.hashCode() ?: 43)
        val `$followers_url`: Any? = this.followers_url
        result = result * PRIME + (`$followers_url`?.hashCode() ?: 43)
        val `$following_url`: Any? = this.following_url
        result = result * PRIME + (`$following_url`?.hashCode() ?: 43)
        val `$gists_url`: Any? = this.gists_url
        result = result * PRIME + (`$gists_url`?.hashCode() ?: 43)
        val `$starred_url`: Any? = this.starred_url
        result = result * PRIME + (`$starred_url`?.hashCode() ?: 43)
        val `$subscriptions_url`: Any? = this.subscriptions_url
        result = result * PRIME + (`$subscriptions_url`?.hashCode() ?: 43)
        val `$organizations_url`: Any? = this.organizations_url
        result = result * PRIME + (`$organizations_url`?.hashCode() ?: 43)
        val `$repos_url`: Any? = this.repos_url
        result = result * PRIME + (`$repos_url`?.hashCode() ?: 43)
        val `$events_url`: Any? = this.events_url
        result = result * PRIME + (`$events_url`?.hashCode() ?: 43)
        val `$received_events_url`: Any? = this.received_events_url
        result = result * PRIME + (`$received_events_url`?.hashCode() ?: 43)
